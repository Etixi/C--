...
int main(){
    ...
    cost = calc_cost(100.00, 0.08); // will use deafult shipping 100 + 8 + 3.50
    cout << "Cost is: " << cost << endl; // 111.50
    
    cost = calc_cost(200.00);   // will use deafult shipping 200 + 12 + 3.50
    ...
    greeting("Jame Rogers", "Professor", "Ph.D.");
