//Section 19 : Challenge_3_Solution
...
// return true fiu the string word_to_find is in the target string
...
int main(){
    ...
    in_file.open("../Section19/Challenge_3_Solution/romeoandjuliet.txt");
    if(!in_file){
